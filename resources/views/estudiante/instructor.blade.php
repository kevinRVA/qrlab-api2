    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-5 mb-4">
            <div class="card shadow-sm h-100 p-4">
                <div class="row mb-4">
        <div class="col-12">
            <h2 class="fw-bold text-dark"><i class="fa-solid fa-chalkboard-user text-primary me-2"></i>Panel de Instructor</h2>
            <p class="text-muted">Inicia y finaliza clases (sesiones de apoyo) para las secciones donde estás asignado como tutor.</p>
        </div>
    </div>        <select id="select-section" class="form-select">
