            ...
            <div class="row">
                ...
                <div class="col-md-2 mb-4 mb-md-0">
                    ...
                    <ul class="list-unstyled small">
                        ...
                        <li class="mb-1"><a
                                href="https://www.utec.edu.sv/Inicio/Catalogos-e-Instructivos/Calendario-Academico">Calendario
                                Académico</a></li>
                    </ul>
                </div>
                <div class="col-md-4 mb-4 mb-md-0">
                    ...
                    <p class="small" style="color:rgba(255,255,255,0.65)">
                        <i class="fa-solid fa-location-dot me-1"></i> Dirección de Educación Virtual. Edificio José
                        Martí 2do y 3er. nivel<br>
                ...
                <div class="col-md-2">
                    ...
                    <div class="d-flex gap-3 fs-4">
                        <a href="https://www.facebook.com/universidadtecnologica"><i
                                class="fa-brands fa-facebook"></i></a>
                        <a href="https://twitter.com/utecedusv"><i class="fa-brands fa-x-twitter"></i></a>
                        <a href="https://api.whatsapp.com/send/?phone=50361000777&text&type=phone_number&app_absent=0"><i
